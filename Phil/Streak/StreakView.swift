        ...
        VStack(spacing: 24) {
            ...
            HStack(spacing: 0) {
                ForEach(0..<7, id: \.self) { col in
                    if col == 6 { // Only day 1 is visible in row 1
                        dayCircle(number: 1, status: .inactive)
                    } else {
                        dayCircle(number: 0, status: .inactive)
                    }
                }
            }
            .padding(.horizontal, 20)
            ...
            // Row 2 (2-8)
            HStack(spacing: 0) {
                dayCircle(number: 2, status: .active)
                dayCircle(number: 3, status: .active)
                dayCircle(number: 4, status: .active)
                dayCircle(number: 5, status: .active)
                dayCircle(number: 6, status: .inactive)
                dayCircle(number: 7, status: .inactive)
                ZStack {
                    dayCircle(number: 8, status: .inactive)
            ...
            // Row 3 (9-15)
            HStack(spacing: 0) {
                dayCircle(number: 9, status: .inactive)
                dayCircle(number: 10, status: .inactive)
                dayCircle(number: 11, status: .active)
                dayCircle(number: 12, status: .active)
                dayCircle(number: 13, status: .active)
                dayCircle(number: 14, status: .active)
                dayCircle(number: 15, status: .active)
            }
            .padding(.horizontal, 20)
            
            // Row 4 (16-22)
            HStack(spacing: 0) {
                dayCircle(number: 16, status: .active)
                dayCircle(number: 17, status: .active)
                dayCircle(number: 18, status: .missed)
                dayCircle(number: 19, status: .inactive)
                dayCircle(number: 20, status: .inactive)
                dayCircle(number: 21, status: .inactive)
                dayCircle(number: 22, status: .inactive)
            }
            .padding(.horizontal, 20)
            
            // Row 5 (23-29)
            HStack(spacing: 0) {
                dayCircle(number: 23, status: .inactive)
                dayCircle(number: 24, status: .inactive)
                dayCircle(number: 25, status: .inactive)
                dayCircle(number: 26, status: .inactive)
                dayCircle(number: 27, status: .inactive)
                dayCircle(number: 28, status: .inactive)
                dayCircle(number: 29, status: .inactive)
            }
            .padding(.horizontal, 20)
            
            // Row 6 (30-31)
            HStack(spacing: 0) {
                dayCircle(number: 30, status: .inactive)
                dayCircle(number: 31, status: .inactive)
                dayCircle(number: 0, status: .inactive)
                dayCircle(number: 0, status: .inactive)
                dayCircle(number: 0, status: .inactive)
                dayCircle(number: 0, status: .inactive)
